          ...
          <div className="column is-half">
            <div class="card is-half ml-0 mr-3">
              ...
              <div class="card-content">
                ...
                <div class="content">
                  <p>Code => Travel => Eat => Repeat</p>
                  < ></>
                  <ul>
                    <li>Originally from Chicago but currently based out of Seattle</li>


                    <li>United States Air Force Veteran</li>


                    <li>Excited for my journey ahead in coding and look forward to learning new things</li>
                  </ul>
                  <br></br>
                </div>
              </div>
